...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var dummyData = [
    { id: 1, foundation_id: 101, title: "Bantu Korban Banjir Jakarta", description: "Donasi untuk korban banjir", deadline: "2026-08-15 23:59:00", target_amount: 50000000, current_amount: 32500000, status: "active", created_at: "2026-06-01 09:00:00", updated_at: "2026-07-10 14:20:00" },
    { id: 2, foundation_id: 102, title: "Sekolah Gratis Anak Yatim", description: "Biaya operasional sekolah", deadline: "2026-09-01 23:59:00", target_amount: 75000000, current_amount: 75000000, status: "completed", created_at: "2026-05-12 10:15:00", updated_at: "2026-07-01 08:00:00" },
    { id: 3, foundation_id: 101, title: "Renovasi Panti Jompo", description: "Perbaikan atap dan fasilitas", deadline: "2026-07-30 23:59:00", target_amount: 20000000, current_amount: 4500000, status: "pending", created_at: "2026-07-05 11:30:00", updated_at: "2026-07-05 11:30:00" },
    { id: 4, foundation_id: 103, title: "Bantuan Medis Darurat", description: "Obat-obatan untuk pengungsi", deadline: "2026-07-20 23:59:00", target_amount: 30000000, current_amount: 12000000, status: "active", created_at: "2026-06-20 08:45:00", updated_at: "2026-07-09 16:10:00" },
    { id: 5, foundation_id: 104, title: "Beasiswa Mahasiswa Kurang Mampu", description: "Bantuan biaya kuliah", deadline: "2026-10-01 23:59:00", target_amount: 100000000, current_amount: 15000000, status: "draft", created_at: "2026-07-11 09:00:00", updated_at: "2026-07-11 09:00:00" },
    { id: 6, foundation_id: 102, title: "Bencana Gempa Cianjur", description: "Bantuan logistik", deadline: "2026-06-30 23:59:00", target_amount: 60000000, current_amount: 60000000, status: "completed", created_at: "2026-04-01 07:00:00", updated_at: "2026-06-30 20:00:00" },
    { id: 7, foundation_id: 105, title: "Vaksinasi Gratis Daerah Terpencil", description: "Program kesehatan masyarakat", deadline: "2026-08-05 23:59:00", target_amount: 40000000, current_amount: 8000000, status: "cancelled", created_at: "2026-05-25 13:00:00", updated_at: "2026-06-15 10:00:00" },
    { id: 8, foundation_id: 103, title: "Pembangunan Sumur Bersih", description: "Akses air bersih desa terpencil", deadline: "2026-09-15 23:59:00", target_amount: 25000000, current_amount: 25000000, status: "active", created_at: "2026-06-10 12:00:00", updated_at: "2026-07-08 09:30:00" },
  ];
  // =====================================================
  ...
  var table = new Tabulator("#donationposts-table", {
    ...
    columns: [
      ...
      { title: "Foundation ID", field: "foundation_id", width: 120, sorter: "number" },
      ...
      },
      {
        ...
        formatter: function (cell) {
          ...
          return `
            <a href="/admin/donationposts/edit/${id}" class="btn btn-xs btn-outline-primary me-1">
